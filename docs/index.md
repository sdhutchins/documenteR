...
Install from
[r-universe](https://sdhutchins.r-universe.dev/documenteR):
...
IF you’ve witten a function but haven’t created documentation for it,
select the function tile, and call the “Document an object” addin, which
